# DeltaNeutralAaveV3UniV3WETHUSDCBaseStrategy - Agent Guide

> AI coding agent context for the `delta_neutral_aave_v3_uni_v3_w_e_t_h_u_s_d_c_base` strategy.

## Overview

- **Template:** multi_step
- **Chain:** base
- **Class:** `DeltaNeutralAaveV3UniV3WETHUSDCBaseStrategy` in `strategy.py`
- **Config:** `config.json`
